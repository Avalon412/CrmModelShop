    ...
    public partial class Main : Form {
        ...
        private void button1_Click(object sender, EventArgs e) {
            if(customer != null) {
                ...
                MessageBox.Show("Покупка произведена успешно. Сумма: " + price, "Успех", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else {
                MessageBox.Show("Авторизуйтесь пожалуйста", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
    }
}
